...
const classicDescription = "This is the classic version of the game. you can choose out of 3 grids 3*3, 5*5, and 7*7."
...
const HomePageBody = () => {
    return (
        <div className="flex-col gap-y-6 home-page-body p-2 sm:p-4 text-[var(--text)]">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 p-4 bg-[var(--background-200)] rounded-none">
                <Card title="Classic Tic Tac Toe" description={classicDescription} />
